 ...
 * 
 */
@WebServiceClient(name = "VendaJaxWSService", targetNamespace = "http://webservice.univel.br/", wsdlLocation = "http://localhost:8080/lab135402/VendaJaxWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName VENDAJAXWSSERVICE_QNAME = new QName("http://webservice.univel.br/", "VendaJaxWSService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/lab135402/VendaJaxWS?wsdl");
    ...
    public VendaJaxWS getVendaJaxWSPort() {
        return super.getPort(new QName("http://webservice.univel.br/", "VendaJaxWSPort"), VendaJaxWS.class);
    }
    ...
    public VendaJaxWS getVendaJaxWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.univel.br/", "VendaJaxWSPort"), VendaJaxWS.class, features);
    }
